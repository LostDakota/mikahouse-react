                ...
                <div className="col-12">
                    <div className="card">
                        <div className="blur-mask">
                            <img id="last-event" className="blur security-images" alt="" src={`${Config.Host}/images/security/last.jpg`} onLoad={ImageTransition('last-event', `${Config.Host}${props.event.image}`)} />
                        </div>
